...
public class UserConstants
{
    ...
    /** 业务系统编码是否唯一的返回结果码 */
    public final static String BUSISYSTEM_CODE_UNIQUE = "0";
    public final static String BUSISYSTEM_CODE_NOT_UNIQUE = "1";

    /** 业务系统名称是否唯一的返回结果码 */
    public final static String BUSISYSTEM_NAME_UNIQUE = "0";
    public final static String BUSISYSTEM_NAME_NOT_UNIQUE = "1";

    /** 接口名称是否唯一的返回结果码 */
    public final static String INTERFACE_NAME_UNIQUE = "0";
    public final static String INTERFACE_NAME_NOT_UNIQUE = "1";
